...
PROJECT_ROOT = os.path.join(os.path.abspath(os.path.join(BASE_DIR, os.pardir)))
...
SECRET_KEY = 'p6ljj!f%1ryoy7(r9a!*@o0x82(y4^5^sw53r!+popvbolif5l'
...
MIDDLEWARE = [
    ...
    'counters.middleware.CounterMiddleware',
]
